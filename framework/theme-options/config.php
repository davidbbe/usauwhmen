...
if (!class_exists('Redux_Framework_Config')) {
    ...
    class Redux_Framework_Config {
        ...
        public function setSections() {
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
                    ...
                    array(
                        ...
                        'options'  => array(
                            'false'  => 'No', 
                            'rotateplane light'     => 'Rotate Plane Light', 
                            'rotateplane dark'      => 'Rotate Plane Dark', 
                            'doublebounce light'    => 'Double Bounce Light', 
                            'doublebounce dark'     => 'Double Bounce Dark', 
                            'wave light'            => 'Wave Light', 
                            'wave dark'             => 'Wave Dark', 
                            'wanderingcubes light'  => 'Wandering Cubes Light', 
                            'wanderingcubes dark'   => 'Wandering Cubes Dark', 
                            'pulse light'           => 'Pulse Light', 
                            'pulse dark'            => 'Pulse Dark', 
                            'chasingdots light'     => 'Chasing Dots Light', 
                            'chasingdots dark'      => 'Chasing Dots Dark', 
                            'threebounce light'     => 'Three Bounce Light', 
                            'threebounce dark'      => 'Three Bounce Dark', 
                            'cube light'            => 'Cube Light', 
                            'cube dark'             => 'Cube Dark', 
                            'fadingcircle light'    => 'Fading Circle Light', 
                            'fadingcircle dark'     => 'Fading Circle Dark', 
                        ),
                        'default'  => 'false',
                    ),
                    ...
                    array(
                        'id'        => 'site-author',
                        'type'      => 'media', 
                        'title'     => __('Site Author Image', MD_THEME_NAME),
                        'subtitle'  => __('Upload your Author Image.', MD_THEME_NAME),
                    ),
                    ...
                    array(
                        'id'        => 'wrap-bgcolor',
                        'type'      => 'color',
                        'title'     => __('Wrap background color', MD_THEME_NAME),
                        'subtitle'  => __('Pick wrap background color.', MD_THEME_NAME),
                        'validate'  => 'color',
                        'default'   => '#f9f9f9',
                    ),
                    ...
                    array(
                        'id'        => 'wrap-bgimage',
                        'type'      => 'media',
                        'title'     => __('Wrap background image', MD_THEME_NAME),
                        'subtitle'  => __('Pick wrap background image.', MD_THEME_NAME),
                    ),
            ...
            $this->sections[] = array(
                ...
                'fields'    => array(
                    ...
                    array(
                        'id'        => 'blog-social',
                        'type'      => 'switch', 
                        'title'     => __('Social Share Post', MD_THEME_NAME),
                        'subtitle'  => __('Enable / disable Social Share Post.', MD_THEME_NAME),
                        'default'   => 1
                    ),
            ...
            $this->sections[] = array(
                'title'     => __('Pages Background', MD_THEME_NAME),
                'icon'      => 'lineicon-photo3',
                'fields'    => array(
                    array(
                        'id'        => 'page-404-bg-header',
                        'type'      => 'media', 
                        'title'     => __('404 Page', MD_THEME_NAME),
                        'subtitle'  => __('Set background image header 404 page', MD_THEME_NAME),
                    ),
                    array(
                        'id'        => 'page-search-bg-header',
                        'type'      => 'media', 
                        'title'     => __('Search Page', MD_THEME_NAME),
                        'subtitle'  => __('Set background image header search page', MD_THEME_NAME),
                    ),
                    array(
                        'id'        => 'page-archive-bg-header',
                        'type'      => 'media', 
                        'title'     => __('Archive Page', MD_THEME_NAME),
                        'subtitle'  => __('Set background image header archive page', MD_THEME_NAME),
                    ),
                )
            );
